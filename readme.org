...
#+begin_example
M-x claude-log-resume-session
#+end_example

Opens Claude Code and resumes the session displayed in the current buffer. Requires the [[https://github.com/stevemolitor/claude-code.el][claude-code]] package.
